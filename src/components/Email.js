...
export default function Email() {
  return (
    <form  method="Post" data-netlify='true' className="mt-10 pb-10 bg-white w-10/12 mx-auto rounded-md opacity-90 md:w-9/12">
      ...
      <br />
      <button
        className="mx-3.5 bg-pink-300 text-white p-2 rounded-xl text-2xl mt-2 md:text-4xl 2xl:text-5xl button submitButton"
        id='contact-submit'
        type='submit'
        style={{ border: "1px solid black" }}
      >
